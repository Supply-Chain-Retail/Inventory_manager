...
# MODULE: System Integration & Core Application Setup
...
# DESCRIPTION: Manages database initialization, dynamic seeding of e-commerce
# datasets (Amazon, Flipkart, Meesho, Myntra), and JSON disk caching.
# ==============================================================================
...
# DESCRIPTION: Built demand forecasting models, feature engineering, data
# preprocessing, HistGradientBoostingRegressor training, and prediction.
# ==============================================================================
def train_model_pipeline():
    ...
    try:
        ...
        # Use HistGradientBoostingRegressor as the single high-performance model
        model_name = "HistGradientBoosting Regressor"
        ...
        model_info = {
            ...
            "status": f"ONLINE (Active - {model_name})",
            "total_records": len(df_clean)
        }
        print(f"✅ Trained Model: {model_name} (R2: {best_metrics['r2']})")
...
# ==============================================================================
# MODULE: Backend API Development & Real-Time WebSockets
# RESPONSIBLE ENGINEER: Afrid Ahamed.B
# DESCRIPTION: Developed REST APIs using FastAPI, handled business logic,
# integrated WebSockets for real-time communication, and connected frontend.
# ==============================================================================
